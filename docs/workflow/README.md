...
- [ ] You understand how the automated `harness-tracer` updates execution traces under `docs/harness-history/`.
- [ ] You know how to collect 5–10 session traces before executing the mathematical optimization cycle.
- [ ] You understand the lifecycle pipeline: **Develop → Trace → Evaluate → Optimize**.