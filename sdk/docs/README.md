...
| [**SDK_CLI.md**](./feature/cli/sdk_cli.md) | CLI commands and run options. | Optional |
...
| [**SDK_STEERING.md**](./feature/orchestration/SDK_STEERING.md) | Steering actions and phase rollback behavior. | Optional |
| [**SDK_TERMINAL_UI.md**](./feature/terminal/SDK_TERMINAL_UI.md) | Terminal formatting and progress display. | Optional |
| [**QA_TESTER.md**](./feature/qa/QA_TESTER.md) | Runtime QA planning, drivers, and evidence. | Optional |
