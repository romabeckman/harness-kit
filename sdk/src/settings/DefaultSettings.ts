...
export const DEFAULT_SETTINGS: HarnessSettingsMap = {
  'claude': {
    ...
    phases: {
      ...
      refinement_questions: { model: 'anthropic.claude-5-sonnet', effort: 'high' },
      refinement_consolidation: { model: 'anthropic.claude-5-sonnet', effort: 'high' },
      ...
      deploy_message: { model: 'anthropic.claude-5-sonnet', effort: 'low' },
  ...
  'antigravity': {
    ...
    phases: {
      ...
      refinement_questions: { model: 'gemini-3.8-flash', effort: 'low' },
      refinement_consolidation: { model: 'gemini-3.8-flash', effort: 'low' },
      ...
      deploy_message: { model: 'gemini-3.8-flash', effort: 'low' },
  ...
  'copilot': {
    ...
    phases: {
      ...
      refinement_questions: { model: 'gpt-5.6-sol', effort: 'low' },
      refinement_consolidation: { model: 'gpt-5.6-sol', effort: 'low' },
      ...
      deploy_message: { model: 'gpt-5.6-luna', effort: 'xhigh' },
