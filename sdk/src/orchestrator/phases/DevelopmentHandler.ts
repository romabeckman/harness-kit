...
export class DevelopmentHandler extends AbstractPhaseHandler {
  ...
  buildDevelopmentPrompt(payload: DevelopmenPayload, context: Reviewontext, _agent?: string): string {
    ...
    return [
      ...
      `  "developerNotes": "Concise summary of work completed for the review phase (maximum 500 characters).",`,
      ...
      `\`developerNotes\` must summarize what was implemented for reviewers and must not exceed 500 characters.`,
      `</expected_output>`,
      ``,
