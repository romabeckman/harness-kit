...
```
IF new_feature OR scope_development OR major_refactoring:
    → MUST invoke `autonomous-orchestrator` skill immediately.
...
* Evaluate high-level system metrics.
* Streamline sub-agent focus and priority.
* Dictate sovereign loop execution strategies.
